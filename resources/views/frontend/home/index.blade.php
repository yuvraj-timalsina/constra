            ...
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-md-12 text-center">
                        <h2 class="slide-title" data-animation-in="slideInLeft">17 Years of excellence in
                        </h2>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 ts-facts">
                    ...
                    <div class="ts-facts-content">
                        <h2 class="ts-facts-num"><span class="counterUp" data-count="1789">0</span>
                        </h2>
                ...
                <div class="col-md-3 col-sm-6 ts-facts mt-5 mt-md-0">
                    ...
                    <div class="ts-facts-content">
                        <h2 class="ts-facts-num"><span class="counterUp" data-count="4000">0</span>
                        </h2>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <img loading="lazy" class="img-fluid" src="{{ asset('frontend/images/services/service-center.jpg')}}"
                ...
                <div class="row shuffle-wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item"
                        ...
                        <div class="project-img-container">
                            <a class="gallery-popup" href="{{ asset('frontend/images/projects/project1.jpg')}}"
                                aria-label="project-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/projects/project1.jpg')}}"
                                    alt="project-img">
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;healthcare&quot;]">
                        <div class="project-img-container">
                            <a class="gallery-popup" href="{{ asset('frontend/images/projects/project2.jpg')}}"
                                aria-label="project-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/projects/project2.jpg')}}"
                                    alt="project-img">
                                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                            </a>
                            <div class="project-item-info">
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item"
                        ...
                        <div class="project-img-container">
                            <a class="gallery-popup" href="{{ asset('frontend/images/projects/project3.jpg')}}"
                                aria-label="project-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/projects/project3.jpg')}}"
                                    alt="project-img">
                                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                            </a>
                            <div class="project-item-info">
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item"
                        ...
                        <div class="project-img-container">
                            <a class="gallery-popup" href="{{ asset('frontend/images/projects/project4.jpg')}}"
                                aria-label="project-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/projects/project4.jpg')}}"
                                    alt="project-img">
                                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                            </a>
                            <div class="project-item-info">
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item"
                        ...
                        <div class="project-img-container">
                            <a class="gallery-popup" href="{{ asset('frontend/images/projects/project5.jpg')}}"
                                aria-label="project-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/projects/project5.jpg')}}"
                                    alt="project-img">
                                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                            </a>
                            <div class="project-item-info">
                    ...
                    <div class="col-lg-4 col-md-6 shuffle-item" data-groups="[&quot;residential&quot;]">
                        <div class="project-img-container">
                            <a class="gallery-popup" href="{{ asset('frontend/images/projects/project6.jpg')}}"
                                aria-label="project-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/projects/project6.jpg')}}"
                                    alt="project-img">
                                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                            </a>
                            <div class="project-item-info">
                ...
                <div id="testimonial-slide" class="testimonial-slide">
                        ...
                        <div class="quote-item">
                            ...
                            <div class="quote-item-footer">
                                <img loading="lazy" class="testimonial-thumb"
                                    src="{{ asset('frontend/images/clients/testimonial1.png')}}" alt="testimonial">
                    ...
                    <div class="item">
                        <div class="quote-item">
                            ...
                            <div class="quote-item-footer">
                                <img loading="lazy" class="testimonial-thumb"
                                    src="{{ asset('frontend/images/clients/testimonial2.png')}}" alt="testimonial">
                                <div class="quote-item-info">
                    ...
                    <div class="item">
                        <div class="quote-item">
                            ...
                            <div class="quote-item-footer">
                                <img loading="lazy" class="testimonial-thumb"
                                    src="{{ asset('frontend/images/clients/testimonial3.png')}}" alt="testimonial">
                                <div class="quote-item-info">
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                ...
                <div class="row all-clients">
                    <div class="col-sm-4 col-6">
                        <figure class="clients-logo">
                            <a href="#!"><img loading="lazy" class="img-fluid"
                                    src="{{ asset('frontend/images/clients/client1.png')}}" alt="clients-logo" /></a>
                        </figure>
                    </div><!-- Client 1 end -->
                    ...
                    <div class="col-sm-4 col-6">
                        <figure class="clients-logo">
                            <a href="#!"><img loading="lazy" class="img-fluid"
                                    src="{{ asset('frontend/images/clients/client2.png')}}" alt="clients-logo" /></a>
                        </figure>
                    </div><!-- Client 2 end -->
                    ...
                    <div class="col-sm-4 col-6">
                        <figure class="clients-logo">
                            <a href="#!"><img loading="lazy" class="img-fluid"
                                    src="{{ asset('frontend/images/clients/client3.png')}}" alt="clients-logo" /></a>
                        </figure>
                    </div><!-- Client 3 end -->
                    ...
                    <div class="col-sm-4 col-6">
                        <figure class="clients-logo">
                            <a href="#!"><img loading="lazy" class="img-fluid"
                                    src="{{ asset('frontend/images/clients/client4.png')}}" alt="clients-logo" /></a>
                        </figure>
                    </div><!-- Client 4 end -->
                    ...
                    <div class="col-sm-4 col-6">
                        <figure class="clients-logo">
                            <a href="#!"><img loading="lazy" class="img-fluid"
                                    src="{{ asset('frontend/images/clients/client5.png')}}" alt="clients-logo" /></a>
                        </figure>
                    </div><!-- Client 5 end -->
                    ...
                    <div class="col-sm-4 col-6">
                        <figure class="clients-logo">
                            <a href="#!"><img loading="lazy" class="img-fluid"
                                    src="{{ asset('frontend/images/clients/client6.png')}}" alt="clients-logo" /></a>
                        </figure>
                    </div><!-- Client 6 end -->
